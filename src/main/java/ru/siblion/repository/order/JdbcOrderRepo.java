...
public class JdbcOrderRepo implements OrderRepo {
    ...
    /**
     * В таблице Taco_Order нет autoGenerate, но почему то работает.
     * Хотя .usingGeneratedKeyColumns("id") подразумевает, что id будет
     * генерироваться и предоставляться базой.
     */
    @Autowired
